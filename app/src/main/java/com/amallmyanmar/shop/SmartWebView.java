...
class SmartWebView {
	...
	// URL configs
	static String ASWV_URL            = "https://www.amallmyanmar.com/";//"https://apps.mgks.dev/swv/?android=true";  		// complete URL of your website or offline webpage "file:///android_asset/offline.html";
	...
	static String ASWV_EXC_LIST       = "amallmyanmar.com";       //separate domains with a comma (,)
